...
const CreateCommentForm: React.FC<CreateCommentType> = ({onFinish, onUpload, AddComment}) => {
    ...
    const titleRef = useRef<HTMLHeadingElement>(null); // Создание ref
    ...
    useEffect(() => {
        // При загрузке компонента прокручиваем страницу до компонента Title
        titleRef.current?.scrollIntoView({ behavior: "smooth" });
    }, []);

    return (
        <div className={styles.CreateComment} ref={titleRef}>
